...
class Board():
	...
	def winner(self, player): #this func defines every possible win combination and in case it happens it returns True
		...
		if self.cells[7]==player and self.cells[8]== player and self.cells[9]== player: #checks if theres X or O in rows number 7,8,9
			return True 
		if self.cells[1]==player and self.cells[5]== player and self.cells[9]== player: #check if theres X or O in rows number 1,5,9
			return True 
		if self.cells[3]==player and self.cells[5]== player and self.cells[7]== player: #check if theres X or O in rows number 3,5,7
			return True 
		if self.cells[7]==player and self.cells[4]== player and self.cells[1]== player: #check if theres X or O in rows number 7,4,1
			return True 
		if self.cells[2]==player and self.cells[5]== player and self.cells[8]== player: #check if theres X or O in rows number 2,5,8
			return True 
		if self.cells[3]==player and self.cells[6]== player and self.cells[9]== player: #check if theres X or O in rows number 3,6,9
			return True 
